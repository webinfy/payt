<div class="main-content-section">
    <ul class="dashboard-menu">
        ...
        <li><a href="<?= HTTP_ROOT . "merchants/payment-success-ratio"; ?>">Payment Success Ratio</a></li>
        <li><a class="active" href="<?= HTTP_ROOT . "merchants/modes-of-payment"; ?>">Mode of Payments</a></li>
    ...
    <div class="main-content" style="min-height: 400px;">
        <h1 style="text-align: center;">Mode of Payments</h1>
        <div class="row">
            <div class="col-md-12">
                <ul class="chart-box">
        ...
        <div class="row">
            <div class="col-md-12 text-center">
                <div id="paymentmod" class="charts"></div>
            </div>
        </div>
        ...
        <script>
            var chart = AmCharts.makeChart("paymentmod", {
                "type": "pie",
                "theme": "light",
                "dataProvider": <?= json_encode($paymentmod_data); ?>,
                "valueField": "total",
                "titleField": "section",
                "innerRadius": "40%",
                "balloon": {
