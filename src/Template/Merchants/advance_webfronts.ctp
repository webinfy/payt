                            ...
                            <td>
                                <div class="action-btn"><i class="fa fa-th" aria-hidden="true"></i>
                                    <ul class="action-btn-list">
                                        ...
                                        <li><a href="<?= HTTP_ROOT . "merchants/deleteAdvanceWebfront/$webfront->unique_id" ?>" onclick="return confirm('Are you sure you want to delete this webfront?')"><i class="fa fa-trash-o" aria-hidden="true"></i>Delete</a></li>
                                    </ul>
                                </div>
                            </td>
                        </tr>
