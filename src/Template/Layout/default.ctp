...
<html>
    ...
    <body>
        <div class="main">
            ...
            <div class="header">
                <div class="wrapper">
                    ...
                    <div class="header-right">
                        <h1><?= !empty($pageHeading) ? $pageHeading : "Merchant Dashboard"; ?></h1> 
                        <div class="account-menu"><i class="fa fa-th" aria-hidden="true"></i></div>
                        <ul class="toplinks-ul">
                            <li><a href="<?= HTTP_ROOT . "merchants/account-setup" ?>"><i class="fa fa-desktop" aria-hidden="true"></i> Account Setup</a></li>
            ...
            <div class="footer">
                <div class="wrapper"><p class="copy-rt-text"><?= SITE_NAME ?> &copy; <?= date('Y') ?>. All Rights Reserved.</p></div>
            </div>
