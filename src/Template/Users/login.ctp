...
<html>
    <head>
        ...
        <style>
            ...
            #flashSuccess {cursor: pointer;font-size: 15px;font-weight: bold;overflow: hidden;padding: 10px 25px;position: fixed;text-align: left;width: auto;z-index: 999999;margin-left: -1%;top: 6%;background-color: #0E9F52;color: #FFF;border-radius: 7px;}
        </style>
            ...
            <div class="content-section">
                <div class="wrapper">                   
                    ...
                    <div class="logon-form-section">
                        <h1>Login</h1>
                        <?= $this->Flash->render(); ?> 
                        <?= $this->Form->create(NULL, ['url' => HTTP_ROOT . "users/login", 'type' => 'POST']); ?>
