<?php $uniqid = $this->request->getParam('pass')[0]; ?>
<!DOCTYPE html>
<html>
    <head>
            ...
            <div class="content-section">
                <div class="wrapper">                   
                    ...
                    <div class="logon-form-section">
                        ...
                        <?= $this->Form->control('otp', ['label' => FALSE, 'placeholder' => 'Enter OTP', 'required' => TRUE, 'autocomplete' => 'off']); ?>
                         <p class="login-links"><a href="<?= HTTP_ROOT . 'users/resendOtp/' . $uniqid; ?>" style="border-bottom: none;"><i class="fa fa-reply" aria-hidden="true"></i>Resend OTP</a></p>
